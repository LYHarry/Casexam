<%@ Page Title="" Language="C#" MasterPageFile="~/Master/ManagerMaster.master" AutoEventWireup="true" CodeFile="SelectCyc.aspx.cs" Inherits="Manager_SelectCyc" %>
    ...
    <div id="manager">
        <div id="opear">
            ...
            <asp:DropDownList ID="DropDownList1" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"
                ...
                <asp:ListItem>车辆名称</asp:ListItem>
                <asp:ListItem>车辆类型</asp:ListItem>
                <asp:ListItem>毁坏情况</asp:ListItem>
                <asp:ListItem>购买时间</asp:ListItem>
            </asp:DropDownList>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        <td><%# Eval("CycName") %></td>
                        <td><%# Eval("CycType") %></td>
                        <td><%# Eval("CycBowrrowSun") %></td>
                        <td><%# Convert.ToDateTime( Eval("CycBuyTime")).ToString("yyyy-MM-dd") %></td>
                        <td><%# Eval("CycRepair") %></td>
                        <td><%# Eval("CycMoney") %></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
