...
public partial class Account_AlterPassword : System.Web.UI.Page
{
    ...
    {
        string str1 = Frame.Value.Trim(); //得到电话号码
        ...
        if (!BasicOperate.PhoneIsLegal(str1))
        {
            Common.MessageBox.Show(this.Page, "手机号码格式不正确!");
            return;
        }
        ...
        if (BLL.UserInfoBusiness.UpdateTel(UserName, str1))
        {
            //跳转主页面
